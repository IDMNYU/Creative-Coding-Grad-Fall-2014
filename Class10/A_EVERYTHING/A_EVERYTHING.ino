...
void loop() {
  ...
  // 5 - OTHER PROXIMITY SENSOR
  otherProxValue = analogRead(OTHERPROXIMITY); // read input value
...
double readSound(int pin, int time)
{
  ...
  // MAX-MIN peak amp, converted to 0-10 scale (was 3.3) :
